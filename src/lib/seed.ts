...
const DEFAULT_ACCOUNTS: Array<
  Pick<Account, 'name' | 'institution' | 'kind' | 'starting_balance' | 'credit_limit' | 'statement_due_day' | 'archived_at'>
> = [
  { name: 'Payroll', institution: 'BPI', kind: 'income', starting_balance: 0, credit_limit: null, statement_due_day: null, archived_at: null },
  { name: 'Family Wallet', institution: 'BPI', kind: 'other', starting_balance: 0, credit_limit: null, statement_due_day: null, archived_at: null },
  { name: 'Savings', institution: 'GoTyme', kind: 'savings', starting_balance: 0, credit_limit: null, statement_due_day: null, archived_at: null },
  { name: 'Allowance', institution: 'Maya', kind: 'spending', starting_balance: 0, credit_limit: null, statement_due_day: null, archived_at: null },
  { name: 'Cash on Hand', institution: null, kind: 'other', starting_balance: 0, credit_limit: null, statement_due_day: null, archived_at: null },
  { name: 'Credit Card', institution: null, kind: 'credit', starting_balance: 0, credit_limit: null, statement_due_day: null, archived_at: null },
]
